...
function loadTrack() {
    // Static file paths
    const data = {
        audioUrl: '../assets/audio/bloom.mp3', // Path to your local audio file
        trackName: 'Bloom', // Track name
        artist: 'The Paper Kites', // Artist name
        albumArt: '../assets/img/albums/thepaperkites.jfif' // Path to your local album art
    };
