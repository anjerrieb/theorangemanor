...
function loadTrack() {
    // Static file paths
    const data = {
        audioUrl: '../assets/audio/linger.mp3', // Path to your local audio file
        trackName: 'Linger', // Track name
        artist: 'The Cranberries', // Artist name
        albumArt: '../assets/img/albums/the_cranberries.jpg' // Path to your local album art
    };
