...
function loadTrack() {
    // Static file paths
    const data = {
        audioUrl: '../assets/audio/bettertogether.mp3', // Path to your local audio file
        trackName: 'Better Together', // Track name
        artist: 'Jack Johnson', // Artist name
        albumArt: '../assets/img/albums/bettertogether.jfif' // Path to your local album art
    };
