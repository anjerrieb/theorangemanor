...
function loadTrack() {
    // Static file paths
    const data = {
        audioUrl: 'assets/audio/theonlyexception.mp3', // Path to your local audio file
        trackName: 'The Only Exception', // Track name
        artist: 'Paramore', // Artist name
        albumArt: 'assets/img/albums/bne.png' // Path to your local album art
    };
    ...
    audio.volume = 0.2;
    volumeControl.value = 0.2; // Sync slider with initial volume
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#000" className="size-6">
